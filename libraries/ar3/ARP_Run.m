classdef ARP_Run < Optimization_Run
    ...
    methods
        ...
        function update_derivatives(obj, order, sigma)
            ...
            obj.current_history_row.total_der_entries = ...
              obj.f_handle.eval_counter(1) * 1 + ...
              obj.f_handle.eval_counter(2) * n + ...
              obj.f_handle.eval_counter(3) * (n * (n + 1)) / 2 + ...
              obj.f_handle.eval_counter(4) * (n * (n + 1) * (n + 2)) / 6;
